...
>
  <div class="container py-16 sm:py-20 md:py-24">
    <div
      class="mx-auto flex w-5/6 flex-col items-center justify-between lg:flex-row"
    >
        ...
        <ul class="list-reset">
          ...
          <li class="block pb-2">
            <a
              ...
              >test.email0123@taylorllorente.com</a
            >
          </li>
      ...
      <div class="py-16 text-center lg:py-0">
        <a
          href="/"
          class="font-butler text-4xl uppercase tracking-wider text-white"
          >TaylorLlorente</a
        >
        <div class="flex items-center justify-center pt-5">
          ...
          <a href="https://www.google.com" class="group">
            ...
            >
              <i
                class="bx bxl-facebook text-secondary transition-colors group-hover:text-white"
              ></i>
            </div>
          </a>
          ...
          <a href="https://www.google.com" class="group">
            ...
            >
              <i
                class="bx bxl-twitter text-secondary transition-colors group-hover:text-white"
              ></i>
            </div>
          </a>
          ...
          <a href="https://www.google.com" class="group">
            ...
            >
              <i
                class="bx bxl-instagram text-secondary transition-colors group-hover:text-white"
              ></i>
            </div>
          </a>
...
<div class="container py-8">
  <p class="text-center font-hk text-base text-secondary">
    All rights reserved © 2023. Made with ❤️ by
    <a href="https://tokomob.net" target="_blank" class="text-primary"
      >Tokomob.net</a
    >.
  </p>
</div>
