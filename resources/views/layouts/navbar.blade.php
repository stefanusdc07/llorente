...
<div x-data="app">
        ...
        <div class="relative z-50 py-6 shadow-xs lg:py-10">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <button @click="mobileSearch = !mobileSearch"
                        ...
                        <img src="/assets/img/icons/icon-search.svg"
                            class="block h-6 w-6 group-hover:hidden sm:h-6 sm:w-6 md:h-6 md:w-6" alt="icon search" />
                        <img src="/assets/img/icons/icon-search-hover.svg"
                            class="hidden h-5 w-5 group-hover:block sm:h-6 sm:w-6 md:h-8 md:w-8"
                            alt="icon search hover" />
                    </button>
                ...
                <a href="/">
                    <img src="/assets/img/taylorllorente_logo.svg" class="w-450 h-auto" alt="logo" />
                </a>
                <div class="flex items-center">
            ...
            <div class="hidden justify-center lg:flex lg:pt-8">
                <ul class="list-reset flex items-center">
                    ...
                    <li class="mr-10">
                        <a href="/"
                            class="block border-b-2 border-white px-2 font-hk text-lg text-secondary text-white transition-all hover:border-primary hover:font-bold hover:text-primary">Home</a>
                    </li>

                    <li class="mr-10">
                        <a href="/about"
                            class="block border-b-2 border-white px-2 font-hk text-lg text-secondary text-white transition-all hover:border-primary hover:font-bold hover:text-primary">About</a>
                    </li>
                    ...
                    <li class="group mr-10 hidden lg:block">
                        <div
                            ...
                            <span
                                class="cursor-pointer px-2 font-hk text-lg text-secondary text-white transition-all group-hover:font-bold group-hover:text-primary">Collections</span>
                            <i
                    ...
                    <li class="mr-10">
                        <a href="/blog"
                            class="block border-b-2 border-white px-2 font-hk text-lg text-secondary text-white transition-all hover:border-primary hover:font-bold hover:text-primary">Blog</a>
                    </li>

                    <li class="mr-10">
                        <a href="/contact#faq"
                            class="block border-b-2 border-white px-2 font-hk text-lg text-secondary text-white transition-all hover:border-primary hover:font-bold hover:text-primary">FAQ</a>
                    </li>

                    <li class="mr-10">
                        <a href="/contact"
                            class="block border-b-2 border-white px-2 font-hk text-lg text-secondary text-white transition-all hover:border-primary hover:font-bold hover:text-primary">Contact</a>
                    </li>
    ...
    <div class="pointer-events-none fixed inset-x-0 z-50 pt-20 opacity-0 transition-all md:top-28"
        ...
        <div class="absolute left-0 top-0 z-40 w-full bg-white px-6 shadow-sm sm:w-1/2">
            ...
            <a href="/account/wishlist.html"
                class="block w-full cursor-pointer border-b border-grey-dark py-3 font-hk font-medium text-secondary">Wishlist
            </a>
                    ...
                    <div x-data="{
                        ...
                        <div class="pl-12 transition-all"
                            ...
                            <a href="/collection-grid.html"
                                class="mt-2 block font-hk font-medium text-secondary">T-Shirts</a>
                            <a href="/collection-grid.html"
                                class="mt-2 block font-hk font-medium text-secondary">Shirts</a>
                            <a href="/collection-grid.html"
                                class="mt-2 block font-hk font-medium text-secondary">Men’s Bags</a>
                            <a href="/collection-grid.html"
                                class="mt-2 block font-hk font-medium text-secondary">Travel Essentials</a>
                        </div>
                    </div>
            ...
            <a href="/about.html"
                class="block w-full cursor-pointer border-b border-grey-dark py-3 font-hk font-medium text-secondary">About
            </a>
            <a href="/contact#faq"
                class="block w-full cursor-pointer border-b border-grey-dark py-3 font-hk font-medium text-secondary">FAQ
            </a>
            <a href="/blog.html"
                class="block w-full cursor-pointer border-b border-grey-dark py-3 font-hk font-medium text-secondary">Blog
            </a>
            <a href="/contact.html"
                class="block w-full cursor-pointer border-b border-grey-dark py-3 font-hk font-medium text-secondary">Contact
            </a>
            <div class="my-8">
                <a href="/login" class="btn btn-primary mb-4 w-full" aria-label="Login button">Login Account</a>

                <a href="/register" class="block pl-3 text-center font-hk text-secondary underline md:text-lg">Create
                    your account</a>
            </div>
        </div>
    </div>
    ...
    <div class="pointer-events-none absolute inset-x-0 top-20 z-50 opacity-0 lg:top-28"
        ...
        <div class="container">
            <div class="z-10 w-full rounded bg-white shadow-sm sm:w-1/2 lg:w-1/4">
                <form action="/search" class="flex items-center rounded-md border border-grey-dark px-4 py-3">
    ...
    <div class="pointer-events-none absolute inset-x-0 z-50 opacity-0"
        ...
        <div class="absolute right-0 top-0 z-10 w-full rounded bg-white px-6 py-6 shadow-sm sm:w-1/2">
            ...
            <a href="/cart" class="mt-4 block pl-3 text-center font-hk text-secondary underline md:text-lg">Go to
                cart page</a>
        </div>
    </div>
    <div>
