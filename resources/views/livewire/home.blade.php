<div class="container" x-data x-init="collectionSliders">
    ...
    <div class="container my-24 mx-auto md:px-6 mt-8 mb-4">
        ...
        <section class="mb-32">
            <div class="p-6 p-4 rounded-lg dark:border-white border-black border-1 dark:border border">
                ...
                <div class="text-center text-white dark:text-white text-black">
                    <h1 class="mb-6 text-3xl font-bold text-white dark:text-white text-black">
                ...
                <div class="mb-16 flex flex-wrap">
                    ...
                    <div class="w-full md:w-1/2 mb-8 md:pl-6">
                        <div class="text-center">
                            <h3 class="mb-4 text-2xl font-bold text-white dark:text-white text-black">Design Furniture Collection</h3>
                            <div
                                class="mb-4 flex items-center text-sm font-medium text-danger dark:text-danger-500 text-white">
                            </div>
                            <p class="mb-6 text-neutral-500 dark:text-neutral-300 text-white dark:text-white text-black">
                            ...
                            <p class="text-neutral-500 dark:text-neutral-300 text-white dark:text-white text-black">
        ...
        <section class="mb-32">
           <div class="p-6 p-4 rounded-lg dark:border-white border-black border-1 dark:border border">
                ...
                <div class="mb-16 flex flex-wrap">
                    ...
                    <div class="w-full md:w-1/2 mb-8 md:pl-6">
                        <div class="text-center">
                            <h3 class="mb-4 text-2xl font-bold text-white dark:text-white text-black">Murano Glass & Lighting</h3>
                            <div
                                class="mb-4 flex items-center text-sm font-medium text-danger dark:text-danger-500 text-white">
                            </div>
                            <p class="mb-6 text-neutral-500 dark:text-neutral-300 text-white dark:text-white text-black">
    ...
    <div class="container my-24 mx-auto md:px-6">
        ...
        <div class="p-6 p-4 rounded-lg dark:border-white border-black border-1 dark:border border">
                ...
                <div class="mb-16 flex flex-wrap">
                    ...
                    <div class="w-full md:w-1/2 mb-8 md:pl-6">
                        <div class="text-center">
                            <h3 class="mb-4 text-2xl font-bold text-white dark:text-white text-black">Taylor Llorente Company Profile
                            </h3>
                            <div
                                class="mb-4 flex items-center text-sm font-medium text-danger dark:text-danger-500 text-white">
                            </div>
        ...
        <section class="mb-32">
           <div class="p-6 p-4 rounded-lg dark:border-white border-black border-1 dark:border border">
                ...
                <div class="mb-16 flex flex-wrap">
                    ...
                    <div class="w-full md:w-1/2 mb-8 md:pl-6">
                        <div class="text-center">
                            <h3 class="mb-4 text-2xl font-bold text-white dark:text-white text-black">Macassar Ebony Furniture Collection</h3>
                            <div
                                class="mb-4 flex items-center text-sm font-medium text-danger dark:text-danger-500 text-white">
                            </div>
                            <p class="mb-6 text-neutral-500 dark:text-neutral-300 text-white dark:text-white text-black">
    ...
    <div class="container my-24 mx-auto md:px-6 mt-8 mb-4">
        <!-- Section: Design Block -->
        <section class="mb-32">
            <div class="p-4 rounded-lg dark:border-white border-black border border-1 dark:border"> 
