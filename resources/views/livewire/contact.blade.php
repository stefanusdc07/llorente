<div
  ...
  >
    ...
    >
      <form>
        <p class="pb-8 font-hk text-lg text-white text-secondary dark:text-white text-black">Any questions? Contact us through Whatsapp or on our contact from below.</p>
        <div
          class="mb-5 grid grid-cols-1 justify-between md:grid-cols-2 md:gap-10"
        >
          <div class="mb-5 sm:mb-0">
            <label for="name" class="mb-2 block font-hk text-secondary"
              >Name</label
            >
            <input
              type="text"
          ...
          <div class="">
            <label for="email" class="mb-2 block font-hk text-secondary"
              >Email address</label
            >
            <input
              type="text"
        ...
        <div class="mb-8 w-full">
          <label for="subject" class="mb-2 block font-hk text-secondary"
            >Subject</label
          >
          <input
            type="text"
        ...
        <div class="mb-8 w-full">
          <label for="message" class="mb-2 block font-hk text-secondary"
            >Message</label
          >
          <textarea
            rows="5"
        ...
        <button class="btn border border-white bg-black text-white hover:bg-gray-800 hover:border-gray-200" aria-label="Submit button">
          Send Enquiry
        </button>
      </form>
    </div>
